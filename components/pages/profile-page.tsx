...
import { getUserTweets } from '@/lib/mock-data';
      ...
      <Tabs defaultValue="tweets" className="w-full">
          ...
          <div className="divide-y divide-gray-200">
            {userTweets.length > 0 ? (
              ...
              <div className="bg-white p-12 text-center">
                ...
                <div className="text-sm text-gray-400">When you post tweets, they'll show up here.</div>
              </div>
            )}
          </div>
        </TabsContent>
        ...
        <TabsContent value="replies" className="mt-0">
          <div className="bg-white p-12 text-center">
            ...
            <div className="text-sm text-gray-400">Your tweets and replies will show up here.</div>
          </div>
        </TabsContent>
        ...
        <TabsContent value="media" className="mt-0">
          <div className="bg-white p-12 text-center">
            ...
            <div className="text-sm text-gray-400">Your photos and videos will show up here.</div>
          </div>
        </TabsContent>
        ...
        <TabsContent value="likes" className="mt-0">
          <div className="bg-white p-12 text-center">
            ...
            <div className="text-sm text-gray-400">Tap the heart on any Tweet to show it some love. When you do, it'll show up here.</div>
          </div>
        </TabsContent>
      </Tabs>
    </div>
